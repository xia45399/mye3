...
import com.summer.mye3.manage.mapper.TbItemDescMapper;
import com.summer.mye3.manage.mapper.TbItemMapper;
...
public class ItemServiceImpl implements ItemService {
    ...
    public TbItemDesc getItemDescById(long itemId) {
        ...
        //把结果添加到缓存
        try {
            stringRedisTemplate.opsForValue().set(REDIS_ITEM_PRE + ":" + itemId + ":DESC", JsonUtils.objectToJson(itemDesc), ITEM_CACHE_EXPIRE, TimeUnit.SECONDS);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return itemDesc;
